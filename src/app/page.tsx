...
type Settings = { phoneHref: string; address: string };

function buildJsonLd(settings: Settings, minPrice: number, maxPrice: number) {
  return {
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            "@type": "Product",
            name: "Gaz butane",
            description: "Bouteilles de gaz butane livrees a domicile a Dakar et banlieue",
            ...
            offers: {
              ...
              offerCount: String(maxPrice > 0 ? 3 : 1),
              availability: "https://schema.org/InStock",
            },
          },
        },
...
export default async function Home() {
  ...
  const jsonLd = buildJsonLd(settings, minPrice, maxPrice);
